...
class LoadDataset(object):
    def __init__(self, opt, main_dir, is_val=True):
        txt_feat_path = main_dir + 'data/CUB2011/CUB_Porter_7551D_TFIDF_new.mat' # size (200, 7551), PredicateMatrix
        # TF_IDF Term: (7551, 20), 20 represents 'words', e.g. 'cat'
        # CUB_Porter_7551D_TFIDF_term.mat
        if opt.splitmode == 'easy':
            # train_cid: (1, 150), test_cid: (1, 50), cls number
            ...
            pfc_feat_path_train = main_dir + 'data/CUB2011/pfc_feat_train.mat' # pfc_feat (8855, 3584)
            pfc_feat_path_test = main_dir + 'data/CUB2011/pfc_feat_test.mat' # pfc_feat (2933, 3584)
            # if validation, 120 for training and 30 for validation
            if is_val:
                train_cls_num = 120
                test_cls_num = 30
            else:
            ...
            # train_cid: (1, 160), test_cid: (1, 40), cls number, sequential order with cls
            ...
            pfc_feat_path_train = main_dir + 'data/CUB2011/pfc_feat_train_hard.mat' # pfc_feat (9410, 3584)
            pfc_feat_path_test = main_dir + 'data/CUB2011/pfc_feat_test_hard.mat' # pfc_feat (2378, 3584)
            # if validation, 130 for training and 30 for validation
            if is_val:
                train_cls_num = 130
                test_cls_num = 30
            else:
