...
if not args.dataset == 'ImageNet' :
    ...
    hyperparameters['cls_train_steps'] = 0

if args.dataset == 'ImageNet' :
    hyperparameters['latent_size'] = 128
    hyperparameters['batch_size'] = 128
    hyperparameters['auxiliary_data_source'] = 'word2vec'
    hyperparameters['xyu_samples_per_class'] =  (200, 0, 400, 0)
    hyperparameters['hidden_size_rule']= {'resnet_features': (1560, 1560, 1160, 1660), 'word2vec': (1450, 660,  460, 660) }
